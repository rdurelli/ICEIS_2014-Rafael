...
%The time that each step took is depicted in Table~\ref{tab:time_each_step} - and the precision and the recall of our approach is shown in Table~\ref{tab:precision_and_recall}. Table~\ref
...
\subsection{Analysis and Interpretation} % (fold)
...
%According to Pressman~\cite{Pressman} we can set $P=28000$, which means typical parameter for commercial applications  
...
% subsection analysis_and_interpretation (end)
